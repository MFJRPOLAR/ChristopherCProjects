...
// this function will use scanf fgets to input from 
// stdin(terminal)
void input(void){
    // declaratoion variable to store input data
    int age;
    ...
    // scanf stops at first string token when it reads a string
    scanf("%s", &name);
